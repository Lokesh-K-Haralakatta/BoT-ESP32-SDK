...
## Supported Features
   ...
   | :-----------: |:-------------------------------------------| :---------| :-------|
   |        1      | Pairing through Bluetooth Low Energy (BLE) | :thumbsup: | Supported in both modes - Webserver as well as in SDK Module |
   ...
   |        3      | Secured HTTP with BoT Service              | :thumbsup: | SDK has got an option of enable / disable https at runtime
